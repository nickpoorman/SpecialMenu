...
Rails.application.config.sorcery.submodules = [:remember_me, :session_timeout, :activity_logging, :brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # -- session timeout --
   config.session_timeout = 2592000                                   # how long in seconds to keep the session alive.
  ...
  config.user_config do |user|
    ...
    # user.activation_token_expiration_period =  300                                  # how many seconds before the
    ...
    # user.lock_expires_at_attribute_name = :lock_expires_at                          # this field indicates whether
      ...
      user.login_lock_time_period = 1.hour                                            # how long the user should be
